...
with other people they may get along with. Users can create avatars
using an avatar custodmizer to easily express themselves.
...
<TechStack techs={['React.js', 'GraphQL', 'TypeGraphQL', 'PostgreSQL', 'Objection.js', 'Docker', 'Kubernetes']} />
